 ...
 */
public class VehiculoVerdugoGarciaAntonioRamon2023 {
    ...
    public VehiculoVerdugoGarciaAntonioRamon2023 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoVerdugoGarciaAntonioRamon2023 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
